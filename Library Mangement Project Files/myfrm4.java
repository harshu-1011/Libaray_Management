...
class myfrm4 extends JFrame implements ActionListener
{
	//1)Declaration 
	JLabel l1,l2,l3,l4,l5,l6,l7;
		JButton b1,b2;
		JTextField p1,t1,t2,t3,t4,t5;
	...
	myfrm4()
	{
		...
		add(l1);			
		add(l2);    add(l3);add(l4);add(l5);add(l6);add(l7);    add(t1);add(t2);add(t3);add(t4);add(t5);
		...
		l7.setBounds(130,300,150,30);
		p1.setBounds(250,140,150,30);
		
		b1.setBounds(170,350,150,30);
		b2.setBounds(170,390,150,30);
	...
	System.exit(0);
		...
		setVisible(true);
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					JOptionPane.showMessageDialog(null," Name & Password & Email & Address & City &  Contact .");
				}
					else if(s1.equals(""))
					{
						...
						else if(s6.equals(""))
						{
							...
							if(s1==("") && s2==("")&& s3==("")&& s4==("")&& s5==("")&& s6==(""))
								...
								{
										JOptionPane.showMessageDialog(null,"Liberian Added Successfully...!!!");
												new myfrm2();
												dispose();
								}
